...
def train(data_dir,
    ...
    log_filename = 'output/model_train.csv'
    ...
    with tf.device(gpu):
        ...
        mg_model.compile(optimizer=Adam(lr=lr),
                         ...
                         loss_weights=[1.0, reg_param],metrics=metrics)
            
        # fit
        mg_model.fit_generator(cvpr2018_gen, 
                               initial_epoch=initial_epoch,
                               epochs=nb_epochs,
                               callbacks=[csv_log, save_callback],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--atlas_file", type=str,
                        dest="atlas_file", default='../data1/1_reg_T1_brain.nii.gz',
                        help="gpu id number")
