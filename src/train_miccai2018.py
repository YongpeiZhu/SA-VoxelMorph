...
if __name__ == "__main__":
    ...
    parser.add_argument("--atlas_file", type=str,
                        dest="atlas_file", default='drive1/My Drive/AA/voxelmorph-master/data1/14_reg_T1_brain.nii.gz',
                        help="gpu id number")
    parser.add_argument("--model_dir", type=str,
                        dest="model_dir", default='drive1/My Drive/AA/voxelmorph-master/models/',
                        help="models folder")
    ...
    parser.add_argument("--load_model_file", type=str,
                        dest="load_model_file", default='drive1/My Drive/AA/voxelmorph-master/models/miccai2018_10_02_init1.h5',
